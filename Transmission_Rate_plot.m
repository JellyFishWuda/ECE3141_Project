...
hold on;
plot(avgBytes,y_value,'o','Color','b','MarkerFaceColor','b');
grid on;
...
legend("Number of Decoder Underflow Events","Decoder Underflow = 0 at " +sprintf("T = %.2f",avgBytes)); 